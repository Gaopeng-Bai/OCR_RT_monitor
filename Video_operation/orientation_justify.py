...
def CalcDegree(srcImage):
    ...
    lines = cv2.HoughLines(dstImage, 1, np.pi / 180, 20)
...
def transfer(path):
    ...
    cv2.imwrite(path, rotate, [int(cv2.IMWRITE_PNG_COMPRESSION), 0])


input_img_file = "../4.png"
...
if __name__ == '__main__':
    ...
    # cv2.imwrite(input_img_file, rotate, [int(cv2.IMWRITE_PNG_COMPRESSION), 0])
    cv2.waitKey(0)
