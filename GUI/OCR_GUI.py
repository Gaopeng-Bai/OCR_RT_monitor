...
class Ui_Monitor(object):
    def setupUi(self, Monitor):
        ...
        self.gridLayout_2.addWidget(self.Run_OCR, 3, 4, 1, 1)
        self.Reset_PDF_output = QtWidgets.QPushButton(self.centralwidget)
        self.Reset_PDF_output.setObjectName("Reset_PDF_output")
        self.gridLayout_2.addWidget(self.Reset_PDF_output, 3, 1, 1, 1)
        ...
        self.mainlayerout.addItem(spacerItem7)
        ...
        self.menuSetting.addAction(self.actionBox_set)
    ...
    def retranslateUi(self, Monitor):
        ...
        self.Run_OCR.setText(_translate("Monitor", "Run"))
        self.Reset_PDF_output.setText(_translate("Monitor", "Reset"))
